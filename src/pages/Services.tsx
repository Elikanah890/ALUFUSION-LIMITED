...
export default function Services() {
  useEffect(() => {
    applySEO({
      title: "Our Services — Aluminium, Glass & Steel Works in Tanzania",
      description:
        "End-to-end aluminium and glass solutions: aluminium fabrication, glass works, steel fabrication, maintenance, custom design, material supply, and project management across Tanzania.",
      path: "/services",
      ...
      schema: {
        ...
        name: "Services — 867 ALUFUSION LIMITED",
      ...
      <section className="py-20 bg-gradient-orange text-white text-center">
        <div className="container-x">
          ...
          <p className="text-lg text-white/90 mb-8">
            Download our full service brochure and pricing guide.
          </p>
          <button
